...
const cartSlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$CourseDemy$2f$front$2d$end$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSlice"])({
    ...
    reducers: {
        ...
        setCart: (state, action)=>{
            state.courseIds = action.payload; // khởi tạo giỏ hàng
        }
    }
});
const { addCourseToCart, removeCourseFromCart, clearCart, setCart } = cartSlice.actions;
...
const loginUserThunk = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$CourseDemy$2f$front$2d$end$2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAsyncThunk"])("auth/login", async (credentials, param)=>{
    ...
    try {
        ...
        // --- LẤY GIỎ HÀNG CỦA USER SAU KHI LOGIN ---
        try {
            const cartRes = await fetch("".concat(("TURBOPACK compile-time value", "http://localhost:8081"), "/cart/user/").concat(data.user.id), {
                headers: {
                    Authorization: "Bearer ".concat(data.token)
                }
            });
            const cartData = await cartRes.json();
            const items = Array.isArray(cartData === null || cartData === void 0 ? void 0 : cartData.cart_items) ? cartData.cart_items : [];
            // Lưu id các khóa học vào redux
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$CourseDemy$2f$front$2d$end$2f$src$2f$features$2f$cart$2f$cartSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setCart"])(items.map((i)=>i.course_id)));
        } catch (err) {
...
//# sourceMappingURL=Documents_CourseDemy_front-end_src_85182a73._.js.map